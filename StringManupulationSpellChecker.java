...
public class NiceStringManipulation_SpellChecker {
	...
	/**
	 * Stores the variations in a TreeSet, then Returns the possible variations on
	 * the misspelled word. Since the corrections are stored in a tree set, they are
	 * automatically printed out in alphabetical order with no repeats.
	 *
	 ...
	 * word. Insert a space at any point in the misspelled word (and check that both
