...
public class CSCD210Lab10
{
   ...
   public static void main(String [] args)throws Exception
   {
       ...
       */
      // the last file copied the contents of commndLine.txt
      inf = FileUtils.openInputFile("commandLine.txt");
      
      fin = new Scanner(inf);
      // is displayed here
      // here content of fin is written to fout
      // fout is connected to output1.txt
      FileUtils.displayFile(fin, fout);
      // but this one is not working I know.
      // we are telling java to use the monitor for printing
      // the contents of commandLine.txt
